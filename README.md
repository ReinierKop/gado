...
* `poetry`: dependency and package management tool

Checks are run as pre-commit hooks using the `pre-commit` library.
...
If you can't or don't want to use the devcontainer, then you should first create a virtual environment. Using poetry:
